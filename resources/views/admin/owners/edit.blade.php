                          ...
                          <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            <form method="post" action="{{route('admin.owners.update', ['owner' => $owner->id])}}">
                                ...
                                <div class="p-2 w-full flex justify-around mt-4">
                                    <button type='button' onclick= "location.href='{{route('admin.owners.index')}}' " class="bg-gray-500 border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">戻る</button>
